		...
		return (
			<div className="page projects">
                <div className="section">
					...
					<TransitionGroup component="div" className="gridSquare">
						{this.state.projects.map((p, i) => {
							...
							return (
                                <Link key={i} to={`/projects${p.link}`} className={p.thumbClass + ' squareGridItem' } style={{'backgroundImage' : "url("+p.bgImage+")"}}>
                                    <ProjectCard styleAnimated={style} project={p}/>
								</Link>
							);
						})}
					</TransitionGroup>
